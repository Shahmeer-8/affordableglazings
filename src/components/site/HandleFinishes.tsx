...
import ironRing from "@/assets/handles/iron-ring.jpg";
import brassHandle from "@/assets/doors-hardware.jpg";

/** One real handle photo, filtered per finish, plus two dedicated photos
    (brass, cast iron) where a filter alone couldn't sell the material. */
const FINISHES = [
  ...
  { name: "Heritage Cast Iron", img: ironRing, filter: "grayscale(1) brightness(0.8) contrast(1.1)" },
];
