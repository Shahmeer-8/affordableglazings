...
const paths = ["/", "/about", "/windows", "/doors", "/rooflights", "/conservatories", "/roofline", "/repairs", "/commercial", "/gallery", ...productSlugs.map((s) => `/products/${s}`), "/testimonials", "/faq", "/privacy", "/terms", "/cookies"];
